...
<div class="modal fade" id="empsignup" tabindex="-1" role="dialog" aria-labelledby="myEmployerModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background-image: url(img/1bck.jpg);">
      ...
      <form class="cd-form" method="post" action="registerEmployer.php" enctype="multipart/form-data" onsubmit="return validateForm()">
					...
					<p class="form-group">
                                            <button id="regsubmit" class="full-width has-padding btn-success"  style="padding:10px; background-color: #e9c46a;color:#1d3557;" required>Create account</button>
					</p>
    ...
    <div id="menu1" class="tab-pane fade"  style="width: 50%;">
      ...
      <form class="cd-form" method="post" action="registerJobseeker.php" enctype="multipart/form-data"  onsubmit="return validateForm()">
					<p class="fieldset" style="padding-right: 30px;">
						<label class="image-replace cd-username" for="empsignup-username" required>Username</label>
                                                <input class="full-width has-padding has-border" id="name" name="name" type="text" placeholder="Enter Username" required>
					...
					<p class="fieldset" style="padding-right: 30px;">
						...
						<input class="full-width has-padding has-border" id="qlf" name="qlf" type="text" placeholder="Qualification" required>
                                        ...
                                        <p class="fieldset" style="padding-right: 30px;">
                                            ...
                                            <input class="full-width has-padding has-border" id="dob" name="dob" type="date" placeholder="date of birth" max="2000-12-31"required>
          ...
          <p class="fieldset" style="padding-right: 30px;">
          <h3 style="color:aliceblue">Upload Your Resume</h3>
						<label class="image-replace cd-username" for="empsignup-username">Resume</label>
                                                <input class="full-width has-padding has-border" id="skills" name="skills" type="file" placeholder="resume" required>
